  ...
  try {
    ...
    await client.create({
      ...
      featuredImage: {
        ...
        asset: {
          _type: 'reference',
          _ref: 'image-https://images.unsplash.com/photo-1473341304170-971dccb5ac1e',
        },
      },
      author: {
        _type: 'reference',
    ...
    await client.create({
      ...
      featuredImage: {
        ...
        asset: {
          _type: 'reference',
          _ref: 'image-https://images.unsplash.com/photo-1521791136064-7986c2920216',
        },
      },
      author: {
        _type: 'reference',
    ...
    await client.create({
      ...
      featuredImage: {
        ...
        asset: {
          _type: 'reference',
          _ref: 'image-https://images.unsplash.com/photo-1522071820081-009f0129c71c',
        },
      },
      author: {
        _type: 'reference',
    ...
    await client.create({
      ...
      featuredImage: {
        ...
        asset: {
          _type: 'reference',
          _ref: 'image-https://images.unsplash.com/photo-1484154218962-a197022b5858',
        },
      },
      author: {
        _type: 'reference',
